...
final List<OdiaLetter> odiaConsonants = [
  ...
  OdiaLetter(character: 'ତ', name: 'Ta', audioPath: 'assets/audio/consonant_ta2.mp3', tileColor: _color(7),  isVowel: false),
  OdiaLetter(character: 'ଥ', name: 'Tha',audioPath: 'assets/audio/consonant_tha2.mp3',tileColor: _color(0),  isVowel: false),
  OdiaLetter(character: 'ଦ', name: 'Da', audioPath: 'assets/audio/consonant_da2.mp3', tileColor: _color(1),  isVowel: false),
  OdiaLetter(character: 'ଧ', name: 'Dha',audioPath: 'assets/audio/consonant_dha2.mp3',tileColor: _color(2),  isVowel: false),
  OdiaLetter(character: 'ନ', name: 'Na', audioPath: 'assets/audio/consonant_na2.mp3', tileColor: _color(3),  isVowel: false),
